...
def main(input_file, response):
    ...
    cont_cont_corr_table.to_html("a.html", render_links=True, escape=False)
    ...
    corr_plots.append(
        "<a href = ~/plots/cont_cont_corr_plot.html>" "cont_cont_corr" "</a>"
    )
    ...
    cat_cat_corr_table.to_html("b.html", render_links=True, escape=False)
    ...
    cat_cont_corr_table.to_html("c.html", render_links=True, escape=False)
    ...
    corr_tables = [
        '<a href = "a.html"> cont_table </a>',
        '<a href = "b.html"> cat_cont_table </a>',
        '<a href = "c.html"> cat_cat_table </a>',
    ]
    ...
    # Brute Force Tables
    brute_force_tables = [
        '<a href = "brute_force_cont_cont.html"> cont_bf </a>',
        '<a href = "brute_force_cat_cont.html"> cat_cont_bf </a>',
        '<a href = "brute_force_cat_cat.html"> cat_cat_bf </a>',
    ]
...
if __name__ == "__main__":
    input_file = "D:/archive2/Boston.csv"
    response = "medv"
